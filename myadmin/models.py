...
class ClientRecord(models.Model):
    ...
    alien_number = models.CharField(max_length=200, blank=True)
    ...
    event = models.ForeignKey(Event, on_delete=models.CASCADE, related_name="client_event", blank=True,null=True)
...
class CourtType(models.Model):
    ...
    hearing_date = models.DateTimeField(verbose_name="Hearing Date", auto_now_add=True, null=True)
    hearing_location = models.CharField(max_length=200, blank=True)
    event = models.ForeignKey(Event, on_delete=models.CASCADE, related_name="court_type_event", blank=True,null=True)
...
class CaseAttachment(models.Model):
    ...
    case_att_id = models.ForeignKey(Case, on_delete=models.CASCADE, null=True, blank=True)
